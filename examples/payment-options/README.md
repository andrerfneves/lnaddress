# Payment Options — LUD-XX POC

This is a **quick, dirty, standalone explainer** for the `paymentOptions` LUD-XX extension. It shows how a single LNURL-pay endpoint can advertise and route payments across multiple Bitcoin rails — Lightning, BOLT12, onchain, Liquid, Ark, Spark — without requiring separate discovery endpoints or breaking existing wallets.
